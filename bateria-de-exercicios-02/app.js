...
const serie = {
  ...
  elencoPrincipla: ['Jennifer Aniston', 'Courteney Cox', 'Lisa Kudrow', 'Matt LeBlanc', 'Matthew Perry', 'David Schwimmer']
}
//console.log(serie)
...
Esta propriedade deve conter os gêneros Hard rock, Blues, Rock-folk, Rock e Heavy Metal.
...
O valor desta propriedade deve indicar que a banda não está na ativa.
...
Abaixo deste comentário, modifique o valor da propriedade ano do album Physical Graffiti para 1976.
*/
const anoLancamento = banda.albuns[1].ano + 1
// console.log(anoLancamento)

/*
10

Acesse o primeiro caractere do valor da propriedade url que está dentro do objeto versionGroup no objeto abaixo.
...
const primeiroCaracter = pokemon.moves[0].versionGroupDetails[1].versionGroup.url[0]
...
Use interpolações.
*/
const propriedade = pokemon.moves[0].versionGroupDetails[1].moveLearnMethod.name
