...
let numeroImpar = 7
console.log('Exercício 02 =>', numeroImpar)
...
console.log('Exercício 03 =>', numeroImpar = 3)
...
console.log('Exercício 04 =>', meExiba)
...
const np = 2
console.log('Exercício 05 => np?', np)
...
console.log('Exercício 06 =>', videoGame)
...
const final = x + y + 7 + w
//            0   5       12 = 24
console.log('Exercício 07 =>', final)
...
console.log('Exercício 08 =>', umNumeroQualquer)
...
console.log(`Exercício 09 => ${curso[0]}${curso[9]}${curso[20]}${curso[26]}`)
...
console.log(`Exercício 10 => ${mensagem}`)
...
- episódios, sendo o valor do tipo number
...
*/
const serie = {
  nome: 'The Waklking Dead',
  temporadas: 10,
  episodios: 310,
  emissora: 'AMC Studios'
}
console.log('Exercício 11 =>', serie)
